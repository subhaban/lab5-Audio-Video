...
document.addEventListener("DOMContentLoaded", (e) => {
 ...
 const  play = document.querrySelector('#play_button');
 const  pause = document.querrySelector('#pause_button');
 const  mute = document.querrySelector('#mute');
 const  unmute = document.querrySelector('#unmute');
 const  seek = document.querrySelector('#seek');
 const  rewind = document.querrySelector('#rewind');
 const  end = document.querrySelector('#end');
